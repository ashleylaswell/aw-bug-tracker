$(function () {
    ...
    $('select').on('change', function () {
        ...
        var url = "/Admin/UsersToProject/GetUsersForProject?projectId=" + this.value;
    ...
    $('#SaveSelectedUsers').click(function () {
        ...
        var url = "/Admin/UsersToProject/SaveSelectedUsers";
